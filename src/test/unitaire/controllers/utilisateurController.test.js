...
describe("Utilisateur Controller", () => {
  ...
  describe("deleteUtilisateur", () => {
    ...
    it("devrait gérer les erreurs de suppression", async () => {
      ...
      utilisateurService.deleteUserById.mockRejectedValue(
  ...
  describe("getAllUtilisateurs", () => {
    ...
    it("devrait gérer les erreurs de récupération", async () => {
      // Arrange
      utilisateurService.getAllUtilisateur.mockRejectedValue(
        new Error("DB error")
      );
  ...
  describe("getUtilisateur", () => {
    ...
    it("devrait gérer les erreurs de récupération", async () => {
      // Arrange
      req.params.id = "1";
      utilisateurService.getUtilisateurById.mockRejectedValue(
        new Error("DB error")
      );
